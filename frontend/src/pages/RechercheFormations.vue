<template>
      ...
      <div class="row g-4">
        ...
        <main class="col-lg-9">
          ...
          <p class="text-muted small m-0">
             <strong>{{ sortedFormations.length }}</strong> formation(s) trouvée(s)
          </p>
  ...
  <div
  v-else-if="sortedFormations.length === 0"
    ...
    <div class="row g-3 align-items-center">
      <div class="col-md-3">
        <div class="result-img-placeholder">
          <span class="material-symbols-outlined" style="font-size: 40px; opacity: 0.4;">
            code
          </span>
        </div>
      </div>
...
const chargerFormations = async () => {
  try {
    ...
    console.log('Formations backend recherche :', formations.value)
  } catch (e) {
    console.error(e)
...
const sortedFormations = computed(() => {
  ...
  if (sortBy.value === 'price-asc') {
    return result.sort((a, b) => (a.prixRemise || a.prix || 0) - (b.prixRemise || b.prix || 0))
  }

  if (sortBy.value === 'price-desc') {
    return result.sort((a, b) => (b.prixRemise || b.prix || 0) - (a.prixRemise || a.prix || 0))
  }
