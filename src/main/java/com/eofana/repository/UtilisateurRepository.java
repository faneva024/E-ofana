...
public interface UtilisateurRepository extends JpaRepository<Utilisateur, Long> {
    ...
    /**
     * T-B-102 : recherche un utilisateur par email en filtrant sur un
     * rôle précis. Utilisée par la connexion formateur, pour rejeter
     * un compte apprenant/admin qui tenterait de se connecter via
     * l'endpoint formateur même avec des identifiants valides.
     */
    Optional<Utilisateur> findByEmailAndRole(String email, RoleUtilisateur role);

    /**
     * T-B-102 : variante existsBy, utile pour des vérifications
     * rapides sans charger l'entité entière.
     */
